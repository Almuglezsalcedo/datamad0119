...
ALTER TABLE customer CHANGE `state/province` `state_province` VARCHAR(45);
ALTER TABLE customer CHANGE `zip/postal` `zip_postal` INT;

INSERT INTO customer (customer_id, customer_name, phone_number,email,address,city,state/province, country, zip/postal, salesperson_salesperson_id) 
...
ALTER TABLE invoice ADD vin VARCHAR(45);
